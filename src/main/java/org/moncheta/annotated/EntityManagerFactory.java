...
import org.moncheta.annotated.anno.Transient;
import org.moncheta.annotated.convention.Conventions;
import org.moncheta.annotated.convention.DefaultConventions;
...
public class EntityManagerFactory {
    ...
    protected Column buildPropertyModel(Class<?> entityClass, String propertyPathName, Field p) {
        ...
        String columnName;
        {
            org.moncheta.annotated.anno.Column annoColumn = p.getAnnotation(org.moncheta.annotated.anno.Column.class);
            if (annoColumn == null) {
